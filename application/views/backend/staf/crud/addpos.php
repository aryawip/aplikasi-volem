            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Tambah Pos Bencana</h4>
                            </div>
                            <div class="content">
                                <form action="<?php echo base_url();?>staf/addpos" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nama Pos</label>
                                                <input type="text" class="form-control border-input" placeholder="Nama Pos" name="nama_pos" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" placeholder="Jenis Bencana" name="jenis_bencana" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Jumlah Relawan</label>
                                                <input type="text" class="form-control border-input" placeholder="Jumlah Relawan yang dibutuhkan" name="jumlah" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Jarak Pos</label>
                                                <input type="text" class="form-control border-input" placeholder="Jarak Pos dari UII" name="jarak" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Alamat</label>
                                                <input type="text" class="form-control border-input" placeholder="Alamat Pos Bencana" name="alamat" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control border-input" placeholder="Jumlah relawan sesuai job yang dibutuhkan" name="keterangan" required></textarea>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="text-center">
                                        <button type="submit" class="btn btn-info btn-fill btn-wd" name="submit">Tambah</button>
                                    </div>
