                                        ...
                                        <tr>
                                            <?php
                                              ...
                                              { 
                                                ...
                                                {
                                                  echo "<tr>
                                                  <td><a href='".base_url("staf/detailpos/".$data->id_pos)."'>".$data->nama_pos."</td>
                                                  <td>".$data->jenis_bencana."</td>
                                                  <td>".$data->keterangan."</td>
                                                  
                                                  <td><a href='".base_url("staf/deletepos/".$data->id_pos)."'>Hapus</a></td>
                                                  </tr>";
                                                }
                                              } 
                                              else
                            ...
                            <div class="content">
                                <form>
                                    <div class="text-center">
                                        <input type="button" value="Tambah Pos" class="btn btn-info btn-fill btn-wd" onclick="window.location.href='<?php echo base_url("staf/formaddpos"); ?>'">
                                    </div>
