        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Member Profil</a>
                </div>
            ...
            <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control border-input" placeholder="" name="" value="<?php echo $this->session->userdata("usernameR"); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Password</label>
                                                <input type="text" class="form-control border-input" placeholder="" name="" value="<?php echo $this->session->userdata("passwordR"); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <!--<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input type="text" class="form-control border-input" placeholder="" name="" value="" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                ...
                <div class="row">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                           <?php
                                              if( ! empty($job_relawan)){
                                                foreach($job_relawan as $data){
                                                  echo "<tr>
                                                  <td>".$data->nama_relawan."</td>
                                                  <td>".$data->nama_job."</td>

                                                  <td><a href='".base_url("relawan/deletejob/".$data->id_relawan)."'>Hapus</a></td>
                                                  </tr>";
                                                }
                                              }else{ 
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Penempatan Pos</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                           <?php
                                              if( ! empty($pos_relawan)){
                                                foreach($pos_relawan as $data){
                                                  echo "<tr>
                                                  <td>".$data->nama_relawan."</td>
                                                  <td>".$data->nama_pos."</td>

                                                  <td><a href='".base_url("relawan/deletepos/".$data->id_relawan)."'>Hapus</a></td>
                                                  </tr>";
                                                }
                                              }else{ 
                                                echo "<tr><td align='center' colspan='7'>Data Tidak Ada</td></tr>";
