        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Volunteer Job</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Pilih Job</h4>
                            </div>
                            <div class="content">
                                <form action="<?php echo base_url();?>relawan/pilihjob" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Job</label>
                                                <input type="text" class="form-control border-input" placeholder="Nama job yang dipilih" name="id_job" required >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="content">
